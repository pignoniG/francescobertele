...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="grid-x">
		...
		<div class="cell content_bib_image">
			...
			if( has_post_thumbnail()){ $biblio_current_image = fly_get_attachment_image_src( get_post_thumbnail_id(),'thumbnail-medium-for-interface' )['src'];}?>

			<img src="<?php echo $biblio_current_image; ?>">
		</div>
